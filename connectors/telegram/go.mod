module github.com/coffeehc/xagent-connectors/connectors/telegram

go 1.26

replace github.com/coffeehc/xagent-connectors => ../..
...
require (
	...
	github.com/coffeehc/xagent-connectors v0.0.0
